...
const VERSION_CHECK_URLS = [
  'https://ghfast.top/raw.githubusercontent.com/TLS-802/TuolingTV/blob/main/VERSION.txt',
  'https://raw.githubusercontent.com/TLS-802/TuolingTV/blob/main/VERSION.txt',
];
